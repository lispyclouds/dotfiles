; inlined from: https://github.com/neovim-treesitter/nvim-treesitter-queries-python/blob/main/queries/highlights.scm
...
; class member variables - plain assignment
((class_definition
  body: (block
    (assignment
...
; class member variables - self.x style
((class_definition
  body: (block
    (assignment
      left: (attribute
